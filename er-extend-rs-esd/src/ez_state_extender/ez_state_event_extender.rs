use crate::ez_state_extender::ez_state_expression_extender::EzStateExpressionExtender;
...
impl EzStateEventFactory for EzStateEvent {
    ...
    fn new_add_talk_list_data_event(talk_list_event_id: u32, option_text_id: u32) -> Self {
        let upgrade_add_talk_list_data_arguments = Self::generate_add_talk_list_data_arguments(talk_list_event_id, option_text_id);
...
impl EzStateEventExtender for EzStateEvent {
    fn generate_add_talk_list_data_arguments(talk_list_event_id: u32, option_text_id: u32) -> &'static mut [EzStateExpression; 3] {
        ...
        let talk_list_end_indicator = EzStateExpression::generate_talk_list_data_end_indicator();
